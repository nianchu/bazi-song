...
description: 用可审计的盲断、反馈、复盘和教学流程分析四柱八字，并持续维护匿名案例库、规则置信度与读盘公式。用于用户提供出生时间、四柱或真实经历，要求学习能量流动、旺衰、调候、喜用神、体用、宾主、资源归属、做功、职业、学历、出身、感情、健康倾向、大运流年应期，要求总结公式或标准读盘步骤，或按清娟体系分析寻根基、找出处、数个数、清混、家里家外、旺点、太极点、贵点与自然成象，以及要求把新反馈沉淀为可复验规则时。
---
